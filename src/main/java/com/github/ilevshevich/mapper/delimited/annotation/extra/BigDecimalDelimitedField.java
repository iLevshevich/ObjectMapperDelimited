...
import com.github.ilevshevich.mapper.delimited.transform.extra.BigDecimalTransform;
...
public @interface BigDecimalDelimitedField {
	...
	Class<? extends TypeTransform> transform() default BigDecimalTransform.class;
}
